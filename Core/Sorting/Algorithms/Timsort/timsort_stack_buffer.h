...
struct timsort_stack_buffer
{
	...
	static constexpr const bool trivial_destructor = std::is_trivially_destructible<ValueType>;
	static constexpr const bool nothrow_destructor = std::is_nothrow_destructible<ValueType>;
	static constexpr const bool nothrow_move = std::is_nothrow_move_constructible<ValueType>;
	static constexpr const bool trivial = std::is_trivial<ValueType>;
